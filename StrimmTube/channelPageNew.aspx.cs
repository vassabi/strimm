...
{
    public partial class channelPageNew : BasePage
    {
        ...
        public bool isFlowplayerEnabeled { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            isFlowplayerEnabeled =bool.Parse(ConfigurationManager.AppSettings["FlowplayerEnable"].ToString());
