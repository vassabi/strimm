...
{
    public partial class Default_2_21_16: BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    ancCreateOrSignUp.InnerText = "sign up free";
                }
            }
            ...
            else
            {
                ...
                if (this.ClientTime != null)
                {
                    ...
                    // MST: Removing for speed improvements (need to revert back later - just temporary move)
            ...
            indiContent.Visible = user != null && user.IsFilmMaker;
