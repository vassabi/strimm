...
{
    public partial class homeDecember : BasePage
    {
        ...
        private void BuildChannelControls(List<ChannelTubeModel> channelList)
        {
            ...
            {
                var categoryChannelList = channelList.Where(c => c.IsFeatured != true)
                                                   .GroupBy(c => c.CategoryName)
                                                   .Select(c => c.ToList());
                var topChannelList = channelList.Where(c => c.IsFeatured == true).ToList();
