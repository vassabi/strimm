<%@ Page Title="" Language="C#" MasterPageFile="~/Strimm.Master" AutoEventWireup="true" CodeBehind="Default_OLD3.aspx.cs" Inherits="StrimmTube.Default_playerBlack" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    <%: System.Web.Optimization.Styles.Render("~/bundles/home_playerBlack/css") %>
...
<a  runat="server" id="ancCreatorLink"  class="ancCreatorLink">
   ...
   <div class="hideInfoScheduleBlock">
    ...
    <div class="televisionByPeople">
            <h2 class="televisionByPeopleH2">Public Television Created By People Like You</h2>
   ...
   <%-- <div class="blackBlock"></div>--%>
    ...
    <div class="whatIs">
            <div class="whatIsTitle">Create You Own TV Network Online</div>
                <div class="whatIsBlock">
                    ...
                    <div class="whatIsStep" > 1. Register Your Channel</div>
                     <div class="whatIsDescription">Sign up & create you own network of channels. <br/>It's free!</div>
                <%--    <a href="LearnMore.aspx" class="stepsBlockDetails">Details</a>--%>
                </div>
                <div class="whatIsBlock">
                    <div class="whatIsIcon">
    ...
    <div class="channelsBG">
        ...
        <div class="whatIskWrapper">
            <div class="whatIsTitle whatIsTitleWhite">See What is Playing on Strimm Now</div>
        <div class="homeBlocksHolder homeBlocksHolderChannels" id="homeBlocksHolder" runat="server">
...
<%--<div class="embeddedView">
    ...
    <h3 class="emneddedTextH3">Transform your daily visitors into fans</h3>
    <div class="emneddedImg"></div>
     <div class="emneddedText">
    
<p>Strimm’s goal is to assist businesses and organizations in engaging first-time visitors that come to their site and turning them into repeat users.  Our platform empowers you to entertain, educate and engage your audience with your own custom 24/7 streaming channel. Doctors can create channels about wellness and healthy living; clothing boutiques can make fashion channels; restaurants of all kinds can make food and culture-related channels. There is virtually limitless possibility to find a niche-related topic.   </p>

<p>Strimm allows for easy channel embedding on any site. While all the behind the scenes scheduling work can be done directly on the Strimm platform, the channel can broadcast directly on your site. Promote your products and services to your customers by adding your own videos and commercials into the channel programming.

 </p>

<p>Entertain and engage your community and keep your visitors coming back.</p>
     </div>
</div>--%>

    <div class="embeddedView">
      <div class="whatIsTitle">Solution for Businesses and Organizations  </div> 
         
    <div class="emneddedImg">
        <img src="images/embeddedViewImg.png" />
    </div>
     <div class="emneddedText">
...
channels. There is virtually limitless possibility to find a niche-related topic for your business or organization.
                 <div class="whatIslearnMore">
                <a href="LearnMore.aspx" class="btnWhatIslearnMore">Learn More</a>
    </div>
</p>
...
<%--<p> <span class="whatIsSubTitle">Transform your daily visitors into fans </span> Strimm’s goal is to assist businesses and organizations in engaging first-time visitors that come to their site and turning them into repeat users.  Our platform empowers you to entertain, educate and engage your audience with your own custom 24/7 streaming channel. Doctors can create channels about wellness and healthy living; clothing boutiques can make fashion channels; restaurants of all kinds can make food and culture-related channels. There is virtually limitless possibility to find a niche-related topic.   </p>

<p>Strimm allows for easy channel embedding on any site. While all the behind the scenes scheduling work can be done directly on the Strimm platform, the channel can broadcast directly on your site. Promote your products and services to your customers by adding your own videos and commercials into the channel programming. </p>
    <p>Entertain and engage your community and keep your visitors coming back.</p>--%>
