<%@ Page Title="" Language="C#" MasterPageFile="~/Strimm.Master" AutoEventWireup="true" CodeBehind="ChannelPageMobile.aspx.cs" Inherits="StrimmTube.ChannelPageMobile" %>
        ...
        $(document).ready(function () {
            ...
            setTimeout(function () {
                ...
                if (app != null && app != undefined) {
                    userInfo = JSON.parse(app.getUserInfo());
...
<%--    <div class="mainWrapperDublicate"></div>--%>
    ...
    <div class="outerWrapper">
            <div class="innerWrapper">
                <div class="videoInfoHolderPlayer">
                    ...
                    <div class="creatorInfoPlayer"><span class="byCreatorName">by</span> <a class="creatorInfoPlayer" id="channelCreatorName" onclick="openCreatorInfoPopup();"></a>
...
<div class="visitMyPage"> 
    <a class="spnVisitMyPage">visit my page</a></div>
            </div>
                        </div> 
                    </div>
    ...
    <div class="TLinfoTopPannel">
            <span class="TVguideTitle TVguideTitleActive" onclick="tabShowAllChannels()" style="cursor:pointer;">TV Guide</span>
 ...
 <div class="social-container">
        ...
        <div class="ChannelInfoCL">
            ...
            <div class="channelNameCL"><div class="titleCLFixed">channel</div><span id="lineupChannelName"></span>
            ...
            <div class="nowPlayingCL"><div class="titleCLFixed">now playing </div> 
             <div class="lineupVideoTitle">  <span id="lineupVideoTitle"></span></div> 
                      
             
            </div>

            <div class="runtimeCL"> <div class="titleCLFixed">runtime</div>
                <div class="durationTimelCL">
                <span id="lineupVideoPlaytime"></span></div>
              
            </div>
            <div class="channelDescriptionCL"><div class="titleCLFixed"><span class="descrCL">description</span></div><span id="lineupVideoDescription"></span>
        ...
        <div class="ChannelInfoCLCloseMobile" onclick="ShowInfoBarMobile()" >
<div class="openChannelInfo"></div>
        </div>
...
<%--                    <iframe class="playerbox video-tracking" id="myVideo1"  width="240px" height="122px" data-frameborder="0" data-webkitallowfullscreen="true" data-mozallowfullscreen="true" data-allowfullscreen="true"></iframe>
            ...
            <div class="recHolder">
                 ...
                 <span class="TLrecordRec TLrecordRecCL" title="When 'Rec' is clicked, a video will be added to your 'Watch Later' library" "="">rec</span>             
             </div>
        ...
        <div class="TLinfoTopPannel">
            <span class="TVguideTitle TVguideTitleActive" onclick="showAllChannels()" style="cursor:pointer;">TV Guide</span>
            <span class="TLchannlesBy" onclick="showCreatorChannels()" style="cursor:pointer;" active>Channels by Robert</span>
          
            <div class="TLpannelIconsHolder">
                <div id="showTopChannels" class="TLtopChannels" title="Show Top Channels" onclick="showTopChannels();">Top Channels</div>
                <div id="showMyChannels" class="TLmyChannels" title="Show My Channels" onclick="showMyChannels();">My Channels</div>
                <div id="showFavoriteChannels" class="TLfavChannels" title="Show Favorite Channels" onclick="showFavoriteChannels()">Favorite Channels</div>
            </div>
...
<li class="footerSocial footerSocialPinterest"><a href="https://plus.google.com/+StrimmTV/posts" target="_blank"></a></li>
   ...
   <%-- <div id="channelPasswordModal" style="display:none; background-color:#fff;">
    ...
    <div id="embeddedLinkInfo">
        ...
        <div id="popupBody">
            <div id="popupContent">
                Want to embed this channel on a website?</br> Visit <a href="/#pricingBlock" class="gotoBusinessSolutions">Business solutions</a> to learn more
            </div>
<%--            <div id="popupActions">
