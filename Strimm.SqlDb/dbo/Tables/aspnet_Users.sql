...
GO
CREATE NONCLUSTERED INDEX [IX_aspnet_Users_UserId]
    ON [dbo].[aspnet_Users]([UserId] ASC, [ApplicationId] ASC, [LoweredUserName] ASC)
    INCLUDE([UserName], [MobileAlias], [IsAnonymous], [LastActivityDate]);
